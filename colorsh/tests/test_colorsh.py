import unittest
from colorsh import Colorsh, Color, Style, ANSI_ESCAPE_SEQUENCE
...
class TestColorsh(unittest.TestCase):
    ...
    def test_decorate_tmux_style(self):
        ...
        self.assertEqual(
            ...
            Colorsh.decorate("example", enc="tmux", style=Style(["bold", "italics"])))

    def test_decorate_tmux_color_and_style(self):
        self.assertEqual(
            "#[fg=colour9,bold,italics,bg=colour12]example",
            Colorsh.decorate(
                "example", enc="tmux", fg=Color("red"), bg=Color("blue"),
